...
function Article(){
  // i18n dict for supplemental headings
  const { dict } = useI18n();
  const d = dict.whatPage;
    ...
    <main className="bg-white pb-40">
      <div className="container-beam max-w-4xl">
        <article className="prose prose-neutral max-w-none text-[15px] leading-relaxed [&_h1]:font-serif [&_h1]:tracking-tight [&_h1]:font-semibold [&_h1]:text-brand-800">
          ...
          <h2 id="principles" className="mt-24 font-serif tracking-tight text-brand-800">{d.principlesSummary}</h2>
          <p className="text-[14px] text-gray-600">{/* explanatory summary left intentionally unlocalized to preserve nuance */}아래 카드는 위 소개 문단(원문) 속 개념들을 한눈에 구조화한 요약입니다.</p>
        ...
        <section id="beginner-guide" className="mt-32 space-y-20">
          <header className="text-center max-w-2xl mx-auto">
            <h2 className="font-serif text-3xl md:text-4xl font-semibold tracking-tight text-brand-800">{d.beginnerGuide}</h2>
            <p className="mt-4 text-[15px] leading-relaxed text-gray-600">{d.beginnerDesc}</p>
          </header>
          {/* Alignment */}
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <figure className="relative rounded-2xl overflow-hidden ring-1 ring-brand-200/60 shadow-soft-lg bg-white">
              <div style={{aspectRatio:'3/2'}} className="w-full">
                <img src="/img/practice1.jpg" alt="Alignment 데모 – 다리와 척추를 길게 뻗으며 벽을 이용해 정렬을 체감" width="1200" height="800" className="w-full h-full object-cover object-center" loading="lazy" decoding="async" />
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start md:items-stretch">
            <figure className="order-last md:order-first relative rounded-2xl overflow-hidden ring-1 ring-brand-200/60 shadow-soft-lg bg-white">
              <div style={{aspectRatio:'3/2'}} className="w-full">
                <img src="/img/practice2.jpg" alt="Props 활용 – 블록과 벨트를 이용한 안정된 자세 지원" width="1200" height="800" className="w-full h-full object-cover object-center" loading="lazy" decoding="async" />
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <figure className="relative rounded-2xl overflow-hidden ring-1 ring-brand-200/60 shadow-soft-lg bg-white">
              <div style={{aspectRatio:'3/2'}} className="w-full">
                <img src="/img/practice3.jpg" alt="Timing 과정 – 안정된 머무름에서 호흡과 정렬을 미세 조정" width="1200" height="800" className="w-full h-full object-cover object-center" loading="lazy" decoding="async" />
              </div>
