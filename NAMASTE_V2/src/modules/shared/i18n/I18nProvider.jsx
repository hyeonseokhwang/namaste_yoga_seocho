...
const dictionaries = {
  ...
  faqPreview: {
    ...
    gurujiPage: {
      ...
      introParas: [
        ...
        '인도에서 태어난 그는 어린 시절 병약했으나, 요가 수련을 통해 스스로를 치유하고 단련했으며,  이후 평생에 걸쳐 요가의 본질과 깊이를 탐구했습니다.  특히 아사나의 정렬과 정밀한 수행을 통해 신체, 마음, 지성, 감정, 영혼이 조화롭게 연결되는 길을 제시했고 이를 전 세계 수련자들과 나누며 가르쳤습니다.',
        '아엥가요가는 그의 철학과 접근 방식을 바탕으로 발전한 수련법으로,  정확한 정렬·주의 깊은 관찰·꾸준한 연습을 중시합니다. 다양한 도구를 활용해 연령·유연성·체력과 관계없이 누구나 요가의 본질과 효과를 경험하도록 안내합니다.'
      ],
      legacyList: [
        '1918년 인도 벨루르에서 출생',
        '1934년 스승 T. 크리슈나마차리아에게서 요가 수련 시작',
        '1950년대 서양 세계에 요가 소개를 본격화',
        '1966년 Light on Yoga 출간 (현대 요가의 고전)',
        '1975년 인도 푸네 RIMYI 설립',
        '2004년 TIME 100 영향력 있는 인물 선정',
        '2014년 Padma Vibhushan 수훈'
      ],
      heritageParas: [
        '아엥가 구루지는 생애 끝까지 요가의 길 위에 서 계셨으며, 요가가 단순한 신체 운동이 아니라 삶을 깊이 있게 변화시키는 실천임을 몸소 보여주었습니다.',
        '그의 가르침은 “정직한 관찰과 꾸준한 정렬”을 통해 자기 인식이 깊어지는 과정을 강조하며 지금도 전 세계 제자들과 가족들을 통해 살아 전해지고 있습니다.'
      ]
    },
    whatPage: {
  ...
  en: {
    ...
    footer: {
      ...
      instagram: 'Instagram',
      location: 'Location',
      locationValue: 'Seocho, Seoul (Practice Space)',
      rights: '© 2025 IYCK. All rights reserved.'
    },
    programsPreview: {
      eyebrow: 'PROGRAMS',
